...
// NewComputeAllocationManager returns a new instance of the ComputeAllocation manager.
func NewComputeAllocationManager(superForge *elektratypes.Elektra, superAPI *Manager.ManagerAPI, superConf *Manager.ManagerConf) *API {
